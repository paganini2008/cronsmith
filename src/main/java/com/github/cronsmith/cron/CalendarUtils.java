...
public abstract class CalendarUtils {
    ...
    private static final Map<String, Month> monthValues = new HashMap<>();
    private static final Map<Month, String> monthNames;
    ...
    static {
        ...
        monthValues.put("JAN", Month.JANUARY);
        monthValues.put("FEB", Month.FEBRUARY);
        monthValues.put("MAR", Month.MARCH);
        monthValues.put("APR", Month.APRIL);
        monthValues.put("MAY", Month.MAY);
        monthValues.put("JUNE", Month.JUNE);
        monthValues.put("JULY", Month.JULY);
        monthValues.put("AUG", Month.AUGUST);
        monthValues.put("SEPT", Month.SEPTEMBER);
        monthValues.put("OCT", Month.OCTOBER);
        monthValues.put("NOV", Month.NOVEMBER);
        monthValues.put("DEC", Month.DECEMBER);
    ...
    public static int getMonthValue(String repr) {
        ...
        return monthValues.get(repr).getValue();
    }
